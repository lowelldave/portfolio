  ...
  public: {
    Tables: {
      ...
      professional_experience: {
        ...
        Relationships: [
          {
            foreignKeyName: "professional_experience_company_ID_fkey"
            columns: ["company_ID"]
            isOneToOne: false
      ...
      project: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "project_work_id_fkey"
            columns: ["work_id"]
            isOneToOne: false
      ...
      project_stack: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "project_stack_stack_id_fkey"
            columns: ["stack_id"]
            isOneToOne: false
      ...
      social: {
        ...
        Relationships: [
          {
            foreignKeyName: "social_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profile"
            referencedColumns: ["id"]
